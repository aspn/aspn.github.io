...
(0, _splitting2.default)(); // DOM elements
...
.staggerTo(DOM.content.home.section, 2, {
  duration: 0.1,
  ease: "Power1.easeInOut",
  opacity: 0,
  height: "100vh"
}, timelineSettings.staggerValue, "start").to(document.body, {
  duration: 0.8,
  ease: "Power1.easeInOut",
  backgroundColor: "#335384"
}, timelineSettings.staggerValue, "start") // Start values for the about section elements that will animate in
...
.to(DOM.content.about.picture, 0.8, {
  ...
  opacity: 1,
  rotation: 0
}, "switchtime+=0.6").staggerTo(DOM.canvas, 0.5, {
  y: "0%",
  ease: "Power1.easeInOut",
  opacity: 1
}, timelineSettings.staggerValue, "switchtime"); // Clicking the about and homepage links will toggle the content area, by playing and reversing the timeline
...
var switchContent = function switchContent() {
  ...
  DOM.links.burger.classList[DOM.content.about.isVisible ? "remove" : "add"]("opened");
  DOM.links.about.anchor.classList[DOM.content.about.isVisible ? "remove" : "add"]("about-opened");
...
},{"splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"oR66","splitting":"Qdhu","gsap":"TpQl","./utils":"MgTz"}]},{},["QvaY"], null)